// HPCSE I: numerical integration: multithreaded version with pthread_create & pthread_join
// Note: S1 and S2 might be in the same cache-line (see false-sharing in the OpenMP slides)
#include <stdio.h>
#include <math.h>
#include "timer.h"
#include <pthread.h>
...
int main(int argc, char *argv[])
{
	...
	pthread_create(&thr2, NULL, work, (void *)&arg2);
